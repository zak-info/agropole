            ...
            <div className='hidden  w-full lg:flex flex-wrap justify-center items-center gap-12 mt-6 '>
                {
                    areas?.map((area, index) => (
                        <div key={index} className='w-2/3 md:w-2/5 lg:w-[370px] py-[40px] lg:h-[384px] flex flex-col items-center bg-gradient-to-bl from-cyan-500 to-cyan-400  justify-start lg:gap-[30px] c-border rounded-[35px] md:rounded-[27px] shadow-[0_20px_25px_-5px_rgba(0,131,224,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)]'>
