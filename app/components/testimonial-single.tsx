...
export default function TestimonialSingle({
  ...
  return (
    <div className="mx-auto relative mt-16  w-full flex flex-col lg:flex-row justify-evenly  space-y-4 md:mt-72 md:space-y-6">
      <div className="rating !flex justify-center  font-black">
        {/* {[...Array(5)].map((_, i) => (
          <svg
            key={i}
        ...
        <span className="w-3/4  text-start text-6xl  text-black ">
          A propos de nous
        </span>
      </div>
